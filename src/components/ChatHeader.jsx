...
const ChatHeader = ({
  ...
  const { selectedConversation, setSelectedConversation, users } =
    useChatStore();
      ...
      <div className="mobile-chat-header border-b border-(--discord-border) bg-(--discord-panel) px-4 py-2">
        <div className="flex items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <Hash className="size-5 shrink-0 text-(--discord-text-muted)" />
          ...
          <div className="hidden items-center gap-1 text-(--discord-text-muted) md:flex">
            <button
              type="button"
            ...
            <div className="mx-1">
              <label className="flex h-7 items-center rounded-md bg-(--discord-rail) px-2">
                <Search className="mr-1 size-3.5" />
                <input
                  type="text"
                  placeholder="Tìm kiếm"
                  className="w-32 bg-transparent text-xs text-(--discord-text) outline-none placeholder:text-(--discord-text-muted)"
                />
              </label>
            </div>
            <button
