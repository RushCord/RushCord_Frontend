    ...
    <>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative shrink-0">
              <img
                src={avatarUrl}
                alt={title}
                className="size-9 rounded-full object-cover border border-white/10 bg-black/10"
                onError={(e) => {
      ...
      {showDissolveConfirm && selectedConversation?.type === "GROUP" && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setShowDissolveConfirm(false);
          }}
          role="presentation"
        >
          <div
          ...
          >
            ...
            <p className="text-sm text-base-content/90">
              Giải tán nhóm sẽ xóa hội thoại nhóm cho tất cả thành viên. Hành động này không thể hoàn tác.
            </p>
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              >
                {isGroupLeaveDissolveLoading ? "Đang xử lý..." : "Giải tán nhóm"}
              </button>
            </div>
          </div>
        </div>
      ...
      {showLeaveConfirm && selectedConversation?.type === "GROUP" && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-base-content/90">
              Bạn có chắc muốn rời khỏi nhóm này? Bạn sẽ không còn nhận tin nhắn từ đoạn chat này.
            </p>
            <p className="mt-2 text-sm">
              Nhóm: <span className="font-medium">{title}</span>
            </p>
            <div className="mt-4 flex justify-end gap-2">
              ...
              >
                {isGroupLeaveDissolveLoading ? "Đang xử lý..." : "Thoát nhóm"}
              </button>
            </div>
          </div>
        </div>
